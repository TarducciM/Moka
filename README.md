...
**Stato: in progettazione.** Non c'è ancora codice né una release. Il piano completo è in [docs/ROADMAP.md](docs/ROADMAP.md).
...
**Status: in design.** No code or release yet. The full plan is in [docs/ROADMAP.md](docs/ROADMAP.md) (in Italian).
