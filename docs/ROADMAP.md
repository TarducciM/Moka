...
65. L'installer NSIS di Tauri, quando lo lancia l'updater, riceve `/UPDATE` e salta la creazione del collegamento nel menu Start (in un aggiornamento normale c'è già). Se la primissima installazione avviene *attraverso* l'updater, il collegamento non esiste e sembra un difetto dell'installer: basta rieseguirlo in modo normale.
